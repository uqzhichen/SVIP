...
dataset = 'Animals_with_Attributes2'
#%%
path = '/data/{}/predicates.txt'.format(dataset)
...
#%%
df['new_des']=des
df.to_csv('attribute/AwA2/new_des.csv')
...
# pdb.set_trace()
#%%
with open('../attribute/w2v/AWA2_attribute.pkl', 'wb') as f:
